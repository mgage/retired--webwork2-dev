...
################################################################################################################
		...
		###	TEST : PRINT VARIABLES TO LOG FILE
			my @testDataA = (	"Problem.pre-header_initialize()  (L&F : Get ready to check if user has a flag for the following variables)\n",
		...
		########################################################################################################
		########################################################################################################
		#####  TUTOR :  Check if user has any Tutorial Flag
		#####  If there is a flag, get the flagged ($setName) else continue with the default $setName	
		if($hasTFlag){
...
############################################################################################################
	...
	####################################################################################################
	##  TEST : PRINT VARIABLES TO LOG FILE
		my @testDataB = (	"Problem.initializer() | Newly Generated Problem Data",
	...
	###############################################################################################
	##  TEST : PRINT VARIABLES TO LOG FILE
		my @testDataC = (	"Problem.initializer() | ",
							"TST 3 | ",
							"$user : ", 
							"$effectiveUser : ",
							"$problem : ",
