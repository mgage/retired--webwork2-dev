...
# $CVSHeader: webwork2/lib/WeBWorK/Constants.pm,v 1.52.4.3.2.4 2009/06/26 00:37:00 gage Exp $
# 
...
$WeBWorK::ContentGenerator::Instructor::Config::ConfigValues = [
    ['General',
		...
		{ var => 'defaultTheme',
		  ...
		  doc2 => 'There are currently five themes (or skins) to choose from: ur, math, math2, session, and moodle.  The theme 
specifies a unified look and feel for the WeBWorK course web pages.',
		  values => [qw(math math2 ur moodle session session2 union)],
		  type => 'popuplist'},
